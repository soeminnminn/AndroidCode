...
import com.s16.drawable.MaterialProgressDrawable
...
class ProgressDialog : AlertDialog {
    ...
    private fun createProgressDialog(): ViewGroup {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            ...
            progressDrawable.setCenterRadius(dpToPixel(16).toFloat())
            progressDrawable.setStrokeWidth(dpToPixel(4).toFloat())
